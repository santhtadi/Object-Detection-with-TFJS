...
! function(e, a) {
    ...
    function n(e, a, i, n) {
        return new(i || (i = Promise))((function(m, t) {
            ...
            function o(e) {
                var a;
                e.done ? m(e.value) : (a = e.value, a instanceof i ? a : new i((function(e) {
                    e(a)
                }))).then(d, s)
            }
            ...
            return n(this, void 0, void 0, (function() {
                ...
                return m(this, (function(m) {
                    switch (m.label) {
                        ...
                        case 1:
                            return o = m.sent(), r = o[0].dataSync(), l = o[1].dataSync(), n.dispose(), i.dispose(o), p = this.calculateMaxScores(r, o[0].shape[1], o[0].shape[2]), c = p[0], y = p[1], u = i.getBackend(), "webgl" === i.getBackend() && i.setBackend("cpu"), f = i.tidy((function() {
